-- ALTERAÇÕES PARA MELHORAR O AUTOCOMPLETE (VERSÃO CORRIGIDA)
...
-- 3. Função para normalizar texto (remove acentos, converte para minúsculo)
...
-- 4. Função para calcular similaridade entre strings
...
-- 11. Criar índices para melhorar performance (apenas se não existirem)
